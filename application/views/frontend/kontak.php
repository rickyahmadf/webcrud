      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="<?php echo site_url('Utama/kontak_submit')?>" method="post" role="form" ">
              <div class="row">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="perihal" id="subject" placeholder="Subject" required>
              </div>
              <div class="form-group mt-3">
